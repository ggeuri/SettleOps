        ...
        <div className="summary-card-grid">
          <div className="card">
            <div className="card__body">
              ...
              <div className="summary-card__value">PAY-20260318-0001</div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card__body">
              <div className="summary-card__label">capturedAmount</div>
          ...
          <div className="card">
            <div className="card__body">
              <div className="summary-card__label">currency</div>
              <div className="summary-card__value">KRW</div>
            </div>
          </div>
        </div>
      </SectionCard>
        ...
        <SectionCard title="환불 CTA">
          <div className="page-section">
            ...
            <div className="action-panel">
              <button type="button" className="btn btn--primary">환불 요청으로 이동</button>
